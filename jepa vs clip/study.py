#!/usr/bin/env python3
"""Reproducible JEPA-vs-CLIP representation study on matched galaxies."""
...
CACHE = Path("/mnt/datasets/pranav/astrojepa_eval_cache")

SPACES = {
    "J_I": CACHE / "crossmodal_scratch_307k_last_image",
    "J_S": CACHE / "crossmodal_scratch_307k_last_spectrum",
    "C_I": CACHE / "crossmodal_scratch_clip_307k_final_image",
    "C_S": CACHE / "crossmodal_scratch_clip_307k_final_spectrum",
}
MODELS = {"jepa": ("J_I", "J_S"), "clip": ("C_I", "C_S")}
